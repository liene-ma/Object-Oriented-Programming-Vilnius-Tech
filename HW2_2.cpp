...
for an item sold at the store. An Invoice should include four data members — a part number 
...
int value. If the quantity is not positive, it should be set to 0. If the price per item is 
